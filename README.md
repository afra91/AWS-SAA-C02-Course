...
Before virtualization the architecture of a server looked this:
...
crash and at worst all the guests would overwriting each other's memories and disk areas.
...
the host CPU even when the guest OS are consuming high amounts of consistent I/O.
...
- Architecture of the hardware the instances run on
